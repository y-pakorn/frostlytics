  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "border-sidebar fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
...
const sidebarMenuButtonVariants = cva(
  `peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-lg py-2 px-4
  ...
  font-semibold data-[active=true]:text-sidebar-accent-foreground data-[active=true]:bg-sidebar-accent
  data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground
  group-data-[collapsible=icon]:size-10! group-data-[collapsible=icon]:p-2.5! group-data-[collapsible=icon]:ml-auto! group-data-[collapsible=icon]:mr-auto!
  [&>span:last-child]:truncate [&>svg]:size-5 [&>svg]:shrink-0`,
  {
    variants: {
      variant: {
        ...
        gradient: `data-[active=true]:bg-[linear-gradient(180deg,_#9b8afb_0%,_#a0aeff_100%)]
          data-[active=true]:text-sidebar-primary-foreground not-data-[active=true]:[&>svg]:text-sidebar-icon-foreground
