  ...
  aria-invalid:border-destructive`,
  {
    variants: {
      variant: {
        ...
        outline: `border shadow-xs bg-primary text-secondary-foreground hover:bg-primary/90 hover:text-accent-foreground`,
        active: `bg-accent-purple text-primary-foreground shadow-xs hover:bg-accent-purple/90`,
        inactive: `bg-transparent text-secondary-foreground hover:bg-secondary/50`,
        secondary:
