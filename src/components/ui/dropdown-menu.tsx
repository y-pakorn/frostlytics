    ...
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          ...
          "data-[side=top]:slide-in-from-bottom-2 border-popover-border z-50",
...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        "focus:bg-popover-foreground/5 focus:text-accent-foreground data-[variant=destructive]:text-destructive",
        ...
        "gap-2 rounded-sm px-2 py-2 text-sm outline-hidden select-none",
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        "text-quaternary-foreground px-2 py-1.5 text-sm font-bold data-[inset]:pl-8",
        className
      )}
      {...props}
    />
